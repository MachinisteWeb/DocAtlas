...
ws.ui.Slot = function () {
    var publics = this,
         ...
         * @private
         * @type {string}
         * @memberOf module:catchow~ws.ui.Slot~
         */
        privates = {};
     ...
     * @memberOf module:catchow~ws.ui.Slot~privates
     */
    ...
    publics.toggleContent = function (sendersSelector, targetsSelector, eventListener) {
        ...
        targetsSelector = targetsSelector || "." + publics.className + ".as-toggles > .component > ." + publics.className + "--items > ." + publics.className + "--item";
